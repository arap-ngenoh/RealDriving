...
import real.export.pdf.ListToPDF;
import realdriving.RealDriving;

public class LibraryAssistantUtil {

    public static final String ICON_IMAGE_LOC = "/resources/icons/car.PNG";
    ...
    public static Object loadWindow(URL loc, String title, Stage parentStage) {
        ...
        try {
            ...
            Logger.getLogger(RealDriving.class.getName()).log(Level.SEVERE, null, ex);
        }
        return controller;
    }
    ...
    public static void initPDFExprot(StackPane rootPane, Node contentPane, Stage stage, List<List> data) {
        ...
        FileChooser.ExtensionFilter extFilter
                = new FileChooser.ExtensionFilter("PDF files (*.pdf)", "*.pdf","*.doc");
        ...
        if (flag) {
            AlertMaker.showMaterialDialog(rootPane, contentPane, Arrays.asList(okayBtn, openBtn), "Completed", "student data has been exported.");
        }
    }
